...
<head>
	...
	<script type="text/javascript" charset="utf-8">
		...
		$(document).on('click', "#cfmapprove", function () {
			if($('#cfmapprove').text() != 'Project Approved'){
		...
		$(document).on('click', "#confirm", function () {
			...
			$('#cfmapprove').text('Project Approved');
			$('#doclib').fadeIn();
			showSuccessToast("<font color='yellow'>Project Phoa II (Cambodia)</font> Has <br />Been Successfully Approved");
		});
...
<body>
				...
				<div id="maincontent">
					...
					<div id="top">
						<div style="float: left;">
							...
							<br />
							<span class="top-emp">Special Interest & Community Service Sodality (SICS)</span>
						</div>
						<div style="float: right;">
							<a href="" id="cfmapprove" class="btn-green btn-large" style="float: right;padding: 8px 45px 8px; margin-left: 5px;  margin-top: 5px; background-image: linear-gradient(#45d122, #176110);"> Approve </a>
							<a href="" id="cfmreject" class="btn-custom btn-large" style="padding: 8px 45px 8px; float: right; margin-top: 5px;"> Reject </a>
						</div>
					</div>
	...
	<div id="popup2">
		<div id="cspmodal">
			Would You Like To Confirm The Approval of this CSP Project?
		</div>
		<br />
